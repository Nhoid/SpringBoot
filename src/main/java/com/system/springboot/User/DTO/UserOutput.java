...
public record UserOutput(Integer id, String name ,String username, String email, String borndate) {
    public UserOutput(User user){
        //CONSTRUTOR ONDE ELE RECEBE UM OBJETO DO TIPO User E CONVERTE PARA ENVIAR PARA O FRONT-END
        this(user.getId(), user.getName(),user.getUsername(), user.getEmail(), user.getStringDate());
    }
}
